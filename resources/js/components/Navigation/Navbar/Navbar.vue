<template>
    <nav>
        <div class="container">
            <div
                class="nav-top d-flex justify-content-between align-items-center"
            >
                <router-link
                    tag="div"
                    to="/"
                ...
                <div class="menu-wrapper d-flex">
                    <div class="badge" v-if="user.role_id !== 4">
                        <v-badge overlap small color="red" value="35">
                    ...
                    <div class="user-dropdown" v-ripple>
                        <div
                            class="user-dropdown-toggle d-flex align-items-center"
        ...
        <div class="nav-control">
            <div class="container">
                <ul class="navigation d-flex align-items-center">
                    <NavItem
                        v-for="(menuItems, index) of menuItems"
                        :menu="menuItems"
                        :key="index"
                    />
                </ul>
