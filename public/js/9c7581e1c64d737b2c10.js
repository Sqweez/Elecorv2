...
/* harmony import */ var _Modals_EditRecurringModal_EditRecurringModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Modals/EditRecurringModal/EditRecurringModal */ "./resources/js/components/Modals/EditRecurringModal/EditRecurringModal.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    EditRecurringModal: _Modals_EditRecurringModal_EditRecurringModal__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  props: {
    title: {
      type: String,
  ...
  computed: {
    recurrings: function recurrings() {
      ...
      return this.$store.getters[_store_getters__WEBPACK_IMPORTED_MODULE_0__["default"].RECURRINGS].filter(function (r) {
    ...
    [
      ...
      _c("ConfirmationModal", {
        attrs: {
          ...
          message: "Вы действительно хотите удалить выбранный платеж?"
        }
      }),
      _vm._v(" "),
