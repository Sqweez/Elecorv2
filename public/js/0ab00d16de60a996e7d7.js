        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                recurring = {
                  paybox_id: _this.recurring.paybox_id,
                  sum: _this.recurring.sum,
                  next_payment: _this.recurring.next_payment,
                  client_id: _this.clientId,
                  connection_id: _this.connectionId,
                  is_active: _this.recurring.is_active
                };
                _context.next = 3;
                return _this.$store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_2__["default"].EDIT_RECURRING, {
                  recurring: recurring,
                  id: _this.recurring.id
                });

              case 3:
                Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_4__["default"])('Успешно отредактировано!');
  ...
  watch: {
    state: function state(val) {
      ...
      if (val) {
        ...
        this.recurring.next_payment = this.recurring.next_payment.split('.').reverse().join('-'); //this.recurring.next_payment = moment(this.recurring.next_payment).format('Y-MM-DD');
    ...
    clientId: function clientId(val) {
      var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this3.loading = true;
                _context2.next = 4;
                return _this3.$store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_2__["default"].GET_CLIENT, _this3.clientId);
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store_getters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../store/getters */ "./resources/js/store/getters/index.js");
/* harmony import */ var _Modals_EditRecurringModal_EditRecurringModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Modals/EditRecurringModal/EditRecurringModal */ "./resources/js/components/Modals/EditRecurringModal/EditRecurringModal.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    EditRecurringModal: _Modals_EditRecurringModal_EditRecurringModal__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  props: {
    title: {
      type: String,
  ...
  methods: {
    ...
    deleteRecurring: function deleteRecurring() {
      var _this2 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.$store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_4__["default"].DELETE_RECURRING, _this2.recurringId);

              case 2:
                _this2.deleteModal = false;
                _this2.recurringId = -1;
                Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_5__["default"])('Автоплатеж удален');
